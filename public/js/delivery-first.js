        ...
        success: function (response) {
            ...
            for (i = 0; i < response.length; i++) {
                html +=
                    ...
                    <li>
                        <form id="cep-encontrado" action="/delivery/selecionar-cep" method="POST">
