...
<!-- End Google Tag Manager -->
    ...
    <script>
        ...
        {{$id = Auth::id()}}
             ...
             var pusher = new Pusher('c14930fdd698633ad169', {
      cluster: 'mt1'
    });
    ...
    channel.bind('my-event', function(data) {
      ...
      console.log( '{{Session::get('client_id')}} ');
      
      if('{{Session::get('client_id')}} ' ==  data['cliente_id']){
      var codigo = '<div class="alert alert-success">Seu pedido de numero "' + data['order_id']+ '" recebeu o status de ' + data['order_status'] +' no Sistema</div>';
      
      
      document.getElementById("preencher").innerHTML += codigo;
      }
    ...
    <header class="clearfix">
        ...
        <div class="container">
           ...
           <div class="pesquisa-produtos clearfix">
                ...
                <ul class="pesquisa-resultado" style="display: none;" </ul>
            </div>
