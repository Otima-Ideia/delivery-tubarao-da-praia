                                ...
                                <div class="container">
                                    ...
                                    <div class="produtos-banner__info">
                                        ...
                                        <div class="btn">
                                            ...
                                            <input class="add-prod" id="{{ $banner->First()->getProduct->id }}" 

                                            name="{{ $banner->First()->getProduct->name_product }}" price="{{$banner->First()->getProduct->price_product}}" type="submit" 
...
@if(Request::url() == 'https://pedidos.otimaideia.com.br/delivery/tupi' || Request::url() == 'https://pedidos.otimaideia.com.br/delivery/boqueirao' || Request::url() == 'https://pedidos.otimaideia.com.br/delivery/sao-vicente' )
	@if($desativado == false && $bool == false)
				<h3 class="alert alert-danger">Atendimento <strong>{{ $shopName->nome_loja }}</strong> das <span>{{ date('h:i',strtotime($configsL->config_time)) }}</span> às <span>{{ date('h:i',strtotime($configsL->config_time_end)) }}</span>, agende seu pedido!</h3>
				@else
				<h3 class="alert alert-success">Atendimento <strong>{{ $shopName->nome_loja }}</strong> das <span>{{ date('h:i',strtotime($configsL->config_time)) }}</span> às <span>{{ date('h:i',strtotime($configsL->config_time_end)) }}</span>, faça seu pedido!</h3>
			@endif

@endif
                                            @if(Request::url() === 'https://pedidos.otimaideia.com.br/delivery' || Request::url() == 'https://pedidos.otimaideia.com.br/delivery/tupi' || Request::url() == 'https://pedidos.otimaideia.com.br/delivery/boqueirao' || Request::url() == 'https://pedidos.otimaideia.com.br/delivery/sao-vicente' )
