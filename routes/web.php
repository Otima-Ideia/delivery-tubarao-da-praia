...
Route::get('delivery/boqueirao', [
    'as' => 'productdelivery.first',
    'uses' => 'DeliveryController@deliveryProductsBQ'
]);
Route::get('delivery/tupi', [
    'as' => 'productdelivery.first',
    'uses' => 'DeliveryController@deliveryProductsTP'
]);
Route::get('delivery/sao-vicente', [
    'as' => 'productdelivery.first',
...
Route::post('cep-sem-cadastro', 'ClientsController@cepSemCadastro');

Route::get('consulta', 'DeliveryController@consulta');
...
Route::get('/delivery/produto/{name}', [

    'as' => 'delivery.product-page',

    'uses' => 'DeliveryController@getProductPage'
...
Route::get('/test-erede', [

    'as' => 'erede.test',

    'uses' => 'eRedeController@create'
...
Route::get('/delivery/categoria/{cat}', [
...
Route::post('/delivery/selecionar-cep', [

    'as' => 'productdelivery.selecionarCep',

    'uses' => 'DeliveryController@getLojascep'
...
Route::get('/delivery/search={name}', [

    'as' => 'productdelivery.search',

    'uses' => 'DeliveryController@productsDeliverySearch'

]);

Route::group(['prefix' => 'delivery', 'as' => 'delivery.', 'middleware' => 'auth'], function () {
    Route::any('/create-order', [

        'as' => 'create-order',

        'uses' => 'DeliveryController@adminCreateOrder'
...
Route::group(['prefix' => 'deliveryman', 'as' => 'deliveyman.', 'namespace' => 'Deliveryman', 'middleware' => 'role:' . strval(\App\User::ROLE_DELIVERYMAN)], function () {
    Route::get('/', [
        'as' => 'index',
        'uses' => '\App\Http\Controllers\Deliveryman\DeliveryManController@index'
    ]);

    Route::post('/delivered', [
        'as' => 'delivered-order',
        'uses' => '\App\Http\Controllers\Deliveryman\DeliveryManController@delivered'
    ]);

    Route::post('/online', [
        'as' => 'online',
        'uses' => '\App\Http\Controllers\Deliveryman\DeliveryManController@online'
    ]);

    Route::post('/updateLocation', [
        'as' => 'online',
        'uses' => '\App\Http\Controllers\Deliveryman\DeliveryManController@updateLocation'
    ]);
});
...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin'], function () {
    ...
    Route::group(['middleware' => 'role:' . strval(\App\User::ROLE_ADMIN) . ',' . strval(\App\User::ROLE_LOJA)], function () {
        ...
        Route::get('/orders/test', [

            'as' => 'orders.test',

            'uses' => 'OrderController@testPusher'
        ...
        Route::get('/order/status/update/{id}/{status}/{ent?}', [
        ...
        Route::group(['middleware' => 'can:admin'], function () {
            ...
            Route::get('/products/search={name}', [
                ...
                'as' => 'products.search-name',

                'uses' => 'ProductsController@searchProductsByName'
            ...
            Route::get('/order/tax/search={name}', [
                ...
                'uses' => 'OrderTaxController@searchOrderTaxName'
            ...
            Route::post('/cashier/store', [
                ...
                'uses' => 'CashierController@store'

            ]);
            Route::post('/cashier/storeP', [
            ...
            Route::post('/cashier/storeC', [
                ...
                'uses' => 'CashierController@storeC'

            ]);
            Route::post('/cashier/storeD', [
            ...
            Route::get('/cashier/storeS', [
                ...
                'uses' => 'CashierController@storeS'

            ]);
            Route::get('/cashier/store/show/{id}', [
            ...
            Route::get('/deliverymantime', [

                'as' => 'deliverymantime.index',

                'uses' => 'DeliverymanTimeController@index'
